...
class Scheduler(pl.Callback):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.scheduled_params: List[Tuple[dict, str, Schedule, Union[None, Callable], str]] = []
    ...
    def get(self, loc: Union[dict, object], key: str):
        if not isinstance(loc, dict):
            loc = loc.__dict__
        for curr_loc, curr_key, curr_sched, *_ in self.scheduled_params:  # get first schedule
