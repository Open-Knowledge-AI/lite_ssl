...
class ResNet(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        proj_in_dim = 512 * block.expansion
        self.fc = nn.Linear(proj_in_dim, num_classes, bias=self.linear_bias)
...
class CifarResNeXt(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        proj_in_dim = 256 * block.expansion
        self.fc = nn.Linear(proj_in_dim, num_classes)
...
if __name__ == "__main__":
    ...
    print(y["latent"].shape)
    for i, stage in enumerate(y["stages"]):
